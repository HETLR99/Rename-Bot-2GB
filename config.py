...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "21254911")
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","renambot")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://JXXS7:JXXS7@cluster0.xxkw0.mongodb.net/?retryWrites=true&w=majority")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://b.top4top.io/p_315802pis0.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6169288210').split()]

    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "romm207") 
